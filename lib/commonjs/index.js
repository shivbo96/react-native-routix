  ...
  async trackEvent(code, type = 'track', metadata) {
    ...
    try {
      ...
      await this.makeRequest(`${this.baseUrl}/api/v1/links/${code}/${type}`, {
        ...metadata,
        anonymous_device_id: (metadata === null || metadata === void 0 ? void 0 : metadata.anonymous_device_id) || (metadata === null || metadata === void 0 ? void 0 : metadata.anonymousDeviceId) || (deviceInfo === null || deviceInfo === void 0 ? void 0 : deviceInfo.anonymous_device_id),
        device_info: (metadata === null || metadata === void 0 ? void 0 : metadata.device_info) || (metadata === null || metadata === void 0 ? void 0 : metadata.deviceInfo) || deviceInfo,
