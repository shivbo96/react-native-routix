...
class RoutixEngine {
  ...
  async getDeviceInfo() {
    ...
    return {
      ...
      locale: Platform.OS === 'ios' ? require('react-native').NativeModules.SettingsManager.settings.appleLocale || require('react-native').NativeModules.SettingsManager.settings.appleLanguages[0] : require('react-native').NativeModules.I18nManager.localeIdentifier,
